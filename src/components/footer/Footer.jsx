...
const Footer = () => {
  return (
    <div>
      ...
      <h6>
        Catalyst is dedicated to transforming your business through a
        comprehensive suite of services. Specializing in bespoke website and app
        development, we craft digital experiences that seamlessly blend
        creativity and functionality. Our expertise extends to IT management,
        ensuring that your technology infrastructure is not just efficient but
        strategically aligned with your business goals. At Catalyst, we take
        cybersecurity seriously, deploying cutting-edge measures to safeguard
        your digital assets. Additionally, our proficiency in cloud computing
        empowers your organization with scalable and agile solutions. With a
        commitment to driving progress and embracing the latest in technology,
        Catalyst is your trusted partner on the journey to digital success.
      </h6>
    </div>
  );
  };
